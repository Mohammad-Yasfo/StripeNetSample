...
using StripeConfig = StripeNetSample.Infrastructure.Payment.Stripe.Configuration.StripeConfiguration;

namespace StripeNetSample.Infrastructure.Payment.Stripe.Services
{
    /// <summary>
